...
Examples:
  ./check_sync.sh --public-rpc https://bsc-rpc.publicnode.com
  ./check_sync.sh --compose-service geth --public-rpc https://bsc-rpc.publicnode.com
  CONTAINER=geth-1 PUBLIC_RPC=https://bsc-rpc.publicnode.com ./check_sync.sh
EOF
}
